  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-center py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg w-full text-center flex flex-col items-center">
        ...
        <div className="relative h-20 w-20 rounded-full border border-red-500/40 bg-red-500/10 text-red-500 flex items-center justify-center shadow-[0_0_20px_rgba(239,68,68,0.25)] mb-8 select-none">
          <Ban className="h-9 w-9 stroke-[1.2] animate-pulse" />
          <div className="absolute inset-0 rounded-full border border-red-500/20 animate-ping opacity-75" />
        </div>

        {/* Page Title & Subtitle */}
        <span className="font-sans text-[10px] sm:text-xs font-bold tracking-[0.25em] text-red-500 uppercase mb-4 block select-none">
          Error 404
        </span>
        
        <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-extrabold text-text-main tracking-tight leading-tight">
          Page Not <span className="font-serif italic font-normal text-red-500">Found</span>
        </h2>
