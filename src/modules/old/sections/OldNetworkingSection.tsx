...
export default function OldNetworkingSection() {
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 text-sm text-text-muted leading-relaxed">
              <p>
                ...
                Infrastructure Partners. Our solutions are designed to simplify
                complex connectivity needs, aligning your networking solutions
                with your business goals and objectives. We ensure
                cost-effective and convenient services that comply with the
                requirements of any industry.
              </p>
              <p>
                MAKc Automation and Solution offers a comprehensive solution for
                networking services, where we deploy, operate, manage, optimize,
                and, most importantly, integrate it seamlessly with
                virtualization. Our planning and process methodologies are
                designed to enhance the productivity of work performances while
                reducing operational costs. Furthermore, we prioritize real-time
                business intelligence, making us the go-to choice as the Best
                wifi extender and networking solution provider in Bangalore.
              </p>
            </div>
          </div>
