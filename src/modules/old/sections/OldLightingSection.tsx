...
import { Eye, Shield, Sparkles, Unlock, Zap } from "lucide-react";
...
export default function OldLightingSection() {
  ...
  return (
    <>
      {/* INTRO SECTION */}
      <section className="border-t border-border-main/50 pt-20 mb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed mb-6 font-medium">
              ...
              perfect ambiance and enhancing your home environment. Explore how
              our LED Lights for Home can transform your living spaces.
            </p>
      ...
      <section className="bg-bg-surface/30 border-y border-border-main/50 py-20 mb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              Do you know, LED Brightness, color, number of LEDs and placement,
              really affect you and your family health? <br />
              <strong>
                Yes! This is the fact from which many of us are still unaware.
              </strong>{" "}
              LED specifications directly impact our health. Thus, it is really
              necessary to make the right decision while selecting the lights
              for your home.
            </p>
            ...
            <div className="pt-4 border-t border-border-main/50 space-y-4 text-xs text-text-muted">
              <p>
                ...
                safe LED selection and placement, guiding you from consultation
                to installation.
              </p>
              <p>
              ...
              <p className="font-semibold text-text-main">
                ...
                solution is a decision that shouldn’t be taken lightly. At MAKc
                Automation & Solutions, we understand the significance of your
                choice and strive to provide you with compelling reasons to
                choose our LED Light for Home.
              </p>
            </div>
          </div>
      ...
      <section className="mb-24 max-w-4xl mx-auto pt-10 px-4 sm:px-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="lit-1" className="border-border-main/50">
              ...
              <AccordionContent className="text-sm text-text-muted leading-relaxed pb-5">
                ...
                draw). We choose configurations based on actual foot-candles and
                lumens required for each specific space, maximizing efficiency.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="lit-3" className="border-border-main/50">
              ...
              <AccordionContent className="text-sm text-text-muted leading-relaxed pb-5">
                Lighting color directly coordinates with circadian rhythms. Warm
                white (2700K) is optimal for evening relaxation, natural white
                (4000K) for kitchens, and cool white (5000K+) for work and focus
                zones.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="lit-4" className="border-border-main/50">
              ...
              <AccordionContent className="text-sm text-text-muted leading-relaxed pb-5">
                While modern smart LED fixtures have a higher upfront cost, they
                pay for themselves inside the first 12-18 months due to low
                power utilization and zero replacement maintenance cycles.
              </AccordionContent>
            </AccordionItem>
